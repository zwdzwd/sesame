...
reIdentify(res_grn$dest_file, sprintf("%s/reidentified_Grn.idat", dest_dir))
reIdentify(res_red$dest_file, sprintf("%s/reidentified_Red.idat", dest_dir))
...
sesameDataPullVariantAnno_InfiniumI(
  platform = c("EPIC"),
  refversion = c("hg19", "hg38"),
  version = "20200704"
)

sesameDataPullVariantAnno_SNP(
  platform = c("EPIC"),
  refversion = c("hg19", "hg38"),
  version = "20200704"
)
