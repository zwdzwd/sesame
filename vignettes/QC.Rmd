...
One can calculate a specific group of metrics by giving the 2nd argument: e.g.,

```{r}
sesameQC_calcStats(sdf, c("dyeBias", "detection"))
```
...
qc
sesameQC_rankStats(qc, sesameQC_publicQC("EPIC"))
```
