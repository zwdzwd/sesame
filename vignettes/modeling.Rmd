...
difference. To do this, we need to first reorganize the summary data by
contrast and levels by calling `summaryExtractCfList`.
...
```{r}
names(cf_list)
head(cf_list$sexMale)
cf_list = DMR(se, cf_list$sexMale)      # merge CpGs to regions / segments
## most significant segments
