...
is **testEnrichment** (surprise). This function calculates the extent of
overlap and apply different statistics for enrichment testing. 

The ```testEnrichment()``` will perform Fisher's exact test and report metrics
about each of the the loaded database sets.
...
```{r plot-meta1, fig.width=4, fig.height=4, fig.align="center"}
