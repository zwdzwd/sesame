...
library(knitr)
df <- data.frame(rbind(
    c("Anno/HM450/Clock_Horvath353", "HM450/EPIC", "Horvath 2013 (24138928)"),
    c("Anno/EPIC/PhenoAge", "HM450/EPIC", "Levine 2018 (29676998)"),
    c("Anno/HM450/SkinBlood", "HM450/EPIC", "Horath 2018 (30048243)"),
    c("Anno/MM285/Zhou347", "MM285", "Zhou 2022")
))
