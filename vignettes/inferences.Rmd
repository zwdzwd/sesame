...
This indicates thaat this mouse is approximately 1.41 months old. The function
...
library(knitr)
df <- data.frame(rbind(
    c("Anno/HM450/Clock_Horvath353.rds", "HM450/EPIC", "Horvath 2013 (24138928)"),
    c("Anno/HM450/Clock_Hannum.rds", "HM450", "Hannum 2013 (23177740)"),
    c("Anno/HM450/Clock_SkinBlood.rds", "HM450/EPIC", "Horath 2018 (30048243)"),
    c("Anno/EPIC/Clock_PhenoAge.rds", "HM450/EPIC", "Levine 2018 (29676998)"),
    c("Anno/MM285/Clock_Zhou347.rds", "MM285", "Zhou 2022")
))
colnames(df) <- c("RDS Key", "Platform", "Reference (PMID)")
kable(df, caption="Epigenetic Clocks")
```
