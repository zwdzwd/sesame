...
bioc/html/ExperimentHub.html) package. You can find the path of the annotation
data storage on your local computer using
...
sesameQC_plotIntensVsBetas(sdf.sb) # with scrub
```
