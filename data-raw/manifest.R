...
manifest <- read.csv('tests/data/EPIC.beta.test/MethylationEPIC_v-1-0_B2.csv',header=T,stringsAsFactors=F, row.names=1)
...
rs2chr <- read.table('tests/data/EPIC.beta.test/rs2chr.csv',stringsAsFactors=FALSE)
