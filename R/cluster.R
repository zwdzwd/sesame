...
row.cluster <- function(
    mat, ..., hc.method='ward.D2', dist.method='euclidean') {
...
#' @return a list of clustered row, column and matrix
#' @import stats
both.cluster <- function(
    mat, extra.row=NULL, extra.column=NULL, hc.method='ward.D2',
